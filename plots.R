...
#=========== Fig. EGH RBE quiz for edward ==================#
#=====================================================================#
degh <- c(0.01 * 0:9, 0.1 * 1:9, 1:150) 
prevalence <- calibrated_HZE_nte_der(degh, 70) 
plot(degh, prevalence, type = 'l', bty = 'u', lwd = 3, ann = FALSE)
#lines(degh,calibrated_HZE_nte_der(degh, 100), col='red')
lines(degh,calibrated_HZE_nte_der(degh, 464), col='green')
lines(degh,calibrated_HZE_nte_der(degh, 253), col='blue')
#======================================================================#
